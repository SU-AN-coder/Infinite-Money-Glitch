...
const V3 = new import_utils.MoveTuple({ name: `${$moduleName}::V3`, fields: [import_bcs.bcs.bool()] });
...
const Subsidies = new import_utils.MoveStruct({
...
const CombinedPayment = new import_utils.MoveStruct({
