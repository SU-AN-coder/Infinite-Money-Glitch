...
var wal_exports = {};
__export(wal_exports, {
  ProtectedTreasury: () => ProtectedTreasury,
  TreasuryCapKey: () => TreasuryCapKey,
  WAL: () => WAL,
  burn: () => burn,
  totalSupply: () => totalSupply
});
module.exports = __toCommonJS(wal_exports);
var import_utils = require("../utils/index.js");
var import_bcs = require("@mysten/sui/bcs");
var object = __toESM(require("./deps/sui/object.js"));
const $moduleName = "@local-pkg/wal::wal";
const WAL = new import_utils.MoveStruct({
  name: `${$moduleName}::WAL`,
  fields: {
    dummy_field: import_bcs.bcs.bool()
  }
});
const ProtectedTreasury = new import_utils.MoveStruct({
  name: `${$moduleName}::ProtectedTreasury`,
  fields: {
    id: object.UID
  }
});
const TreasuryCapKey = new import_utils.MoveStruct({
